...
export const SEMANTIC_TOKENS: SemanticToken[] = [
  { name: "background-1", cssVar: "--c-color-background-1", light: "#FCFDFE", dark: "#171924", role: "page ground" },
  { name: "background-2", cssVar: "--c-color-background-2", light: "#FFFFFF", dark: "#0D1421", role: "nav, ticker" },
  { name: "surface-1", cssVar: "--c-color-surface-1", light: "#FFFFFF", dark: "#222531", role: "cards, chart surface" },
  { name: "surface-2", cssVar: "--c-color-surface-2", light: "#F8FAFD", dark: "#2B2E3D", role: "inputs, row hover" },
  { name: "gray-200", cssVar: "--c-color-gray-200", light: "#EFF2F5", dark: "#323546", role: "hairline, chart grid" },
];
...
export const STATUS_TOKENS: SemanticToken[] = [
  ...
  { name: "no-access", cssVar: "--c-color-no-access", light: "#858CA2", dark: "#858CA2", role: "gated" },
];

export const TEXT_TOKENS: SemanticToken[] = [
  { name: "text-primary", cssVar: "--c-color-text-primary", light: "#0D1421", dark: "#FFFFFF", role: "body ink" },
  { name: "text-secondary", cssVar: "--c-color-text-secondary", light: "#616E85", dark: "#A1A7BB", role: "labels, axes" },
  { name: "text-caption", cssVar: "--c-color-text-caption", light: "#A6B0C3", dark: "#646B80", role: "meta only" },
...
export const SERIES_SLOTS: SeriesSlot[] = [
  { slot: 1, cssVar: "--c-chart-series-1", hue: "orange", light: "#C2410C", dark: "#F97316" },
